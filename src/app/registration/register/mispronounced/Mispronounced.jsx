...
export default function MispronouncedEnrollmentForm() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-white to-blue-50 py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-2xl p-8">
        <h1 className="text-3xl font-bold text-center text-blue-900 mb-6">
          Lagos OMA Diction Awards - Student Words Often Mispronounced Enrollment Form
        </h1>
        ...
        <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-800 p-4 mb-8 rounded">
          ...
          <p className="mt-2 text-red-700 font-semibold">This payment and the information provided below is for <strong>one pupil only</strong>.</p>
        </div>

        <form
          action="https://submit-form.com/DN6fnPb9M"
          method="POST"
          className="space-y-6"
        >
          {/* Student Info */}
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <input name="School WhatsApp" placeholder="School WhatsApp No" required className="input" />
          </div>
