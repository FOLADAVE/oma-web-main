...
const About = () => {
  return (
    <div className="bg-slate-100 mx-auto my-10 px-5" id="about">
      ...
      <h2 className="text-center mt-20 font-bold text-3xl sm:text-4xl text-indigo-900">What we offer</h2>
      ...
      <div className="program relative flex-[31%] sm:w-full mb-6">
        <Image
          ...
          height={200}
        />
        <div className="caption absolute top-0 left-0 bottom-0 right-0 bg-[rgba(0,15,152,0.3)] rounded-lg flex items-center justify-center flex-col text-white opacity-0 cursor-auto transition-all duration-400 hover:opacity-100">
          <Image
